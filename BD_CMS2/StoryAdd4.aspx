<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoryAdd4.aspx.cs" Inherits="BD_CMS2.StoryAdd4" %>
...
<head runat="server">
    ...
    <script>
        $(function () {
            $("#<%=btnSaveStory.ClientID%>").click(function () {
        ...
        <div class="container">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="row-height">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:Button ID="btnSaveStory" runat="server" CssClass="btn btn-success btn-large" Text="Save Story" OnClick="btnSaveStory_Click" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="row-height">
                        <div class="col-md-2 text-left">
                            <select id="selHold" runat="server">
                        ...
                        <div class="col-md-2 text-right">
                           <asp:Label ID="lbByline" runat="server" Text="Set Byline? " CssClass="form-control" BackColor="#99CCFF" ForeColor="White"></asp:Label>
                        </div>
                        <div class="col-md-1 text-right">                           
                            <select id="selByLine" runat="server" name="selByLine" class="ms-cms">
                ...
                <div class="row">
                    <div class="row-height">
                        <div class="col-md-8">                            
                            <asp:TextBox ID="tags" runat="server" placeholder="Taxonomy" CssClass="form-control" Font-Size="X-Small"></asp:TextBox>
                        </div>

                        <div class="col-md-2 text-right">
                            <asp:Label ID="lbSendToReview" runat="server" Text="Send Review?  " CssClass="form-control" BackColor="#99CCFF" ForeColor="White"></asp:Label>
                        </div>
                        <div class="col-md-1 text-right">                            
                             <select id="selReview" runat="server" name="selReview" style="background-color: #99CCFF; color: #FFFFFF">
                                <option selected="selected">Yes</option>
                                <option>No</option>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="row-height">
                        <div class="col-md-12 text-left">                           
                            <asp:TextBox ID="tbHeading" runat="server" placeholder="Headline" CssClass="form-control" Font-Bold="True" BackColor="#FFFFCC"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row">
