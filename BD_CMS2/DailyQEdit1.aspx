<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyQEdit1.aspx.cs" Inherits="BD_CMS2.DailyQEdit1" %>
...
Styles|Format|Font|FontSize|TextColor|BGColor|-|About|Scayt"
                ...
                <%--<div class="ui-widget">
                    ...
                    <asp:DropDownList ID="ddlLocation" runat="server">
                        ...
                        <asp:ListItem></asp:ListItem>
                            ...
                            <td class="auto-style11">NZX:&nbsp;   
                            <asp:DropDownList ID="ddlTicker" runat="server" DataSourceID="SqlDataSource2" DataTextField="Name" AppendDataBoundItems="true" DataValueField="Ticker" Height="21px" Width="221px">
                                <asp:ListItem Value="0" Text=" "></asp:ListItem>
                            </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td class="">Publish Hold?&nbsp;<asp:DropDownList ID="ddlHold" runat="server">
                                <asp:ListItem Selected="True">No</asp:ListItem>
                                <asp:ListItem>Yes</asp:ListItem>
                                <asp:ListItem></asp:ListItem>
                            </asp:DropDownList>
                            ...
                            <td class="auto-style11">ASX:&nbsp; 
                            <asp:DropDownList ID="ddlASX" runat="server" DataSourceID="SqlDataSource1" DataTextField="Name" AppendDataBoundItems="true" DataValueField="Ticker" Height="23px" Width="218px">
                                <asp:ListItem Value="0" Text=" "></asp:ListItem>
                            </asp:DropDownList>
                            </td>
                            <td class="auto-style12">Send to Review?&nbsp;<asp:DropDownList ID="ddlSendToReview" runat="server">
                ...
                <div>
                    <div class="ui-widget">
                        ...
                        <asp:TextBox ID="tags" runat="server" Font-Size="X-Small" Width="897px" Height="33px"></asp:TextBox>
                    </div>
                    <div class="ui-widget">
                        <table class="nav-justified">
                            <tr>
